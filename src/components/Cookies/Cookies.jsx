    ...
    <>
      {afficherCookie && (
        <div className="z-30 h-auto  tablette:h-full flex flex-row justify-center items-center fixed bottom-0 pt-6 text-textColor w-full text-center text-sm">
          <div className="flex xl:flex-row tablette:flex-col mobile:w-full  w-5/6 py-6  bg-background/90 gap-6 align-middle rounded-xl borderShadow  mb-6 items-center justify-evenly mobile:justify-center">
            <Image
            ...
            <div className="flex flex-col w-2/3 tablette:w-5/6 mobile:w-full">
              <div className="flex flex-col items-center ">
                ...
                <p className="text-lg mobile:text-base text-left tablette:text-sm mobile:w-full mobile:px-4 leading-10 p-2 rounded-md bg-background/50 ">
              ...
              <div className="flex flex-row mobile:flex-wrap items-center tablette:mt-8 mobile:mt-0 justify-center gap-6 mobile:gap-1 bg-background/50">
                <button
